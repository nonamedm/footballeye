			...
			success : function (result) {
				...
				for(i=startNum; i<endNum; i++) {
					...
					if(result.getAnalysisList[i].SFILE_NAME!=null){
						...
						var youtubeUrl = result.getAnalysisList[i].BOARD_CONT.substring(result.getAnalysisList[i].BOARD_CONT.indexOf('www.youtube'),result.getAnalysisList[i].BOARD_CONT.indexOf('" width='))
