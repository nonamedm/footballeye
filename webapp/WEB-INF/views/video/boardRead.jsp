														...
														<div id="mission" data-tab-icon=""
								                            ...
								                            <div class="container">
																...
																<table class="table">
																	...
																	<tr>
																	<th style="width:30%; text-align:left; border-right:0px; padding-left:20px;">${getBoardRead.USER_NAME } ( ${getBoardRead.USER_ID} )</th>
																	<th style="width:15%; border-left:0px; border-right:0px;">${getBoardRead.BOARD_REGDATE }</th>
																	<th style="width:15%; border-left:0px;">조회 : ${getBoardRead.BOARD_READCOUNT}</th></tr>
																	<tr><td colspan="3" style="width:100%; vertical-align: baseline; padding:20px; background-color:white;">
																		<c:forEach var="getFileList" items="${getFileList }">
																			<video controls width="30%" src="file/${getFileList.SFILE_NAME}" poster="/file/play.png"/>썸네일을 제공하지 않습니다</video>
																		</c:forEach>
