														...
														<div id="mission" data-tab-icon=""
								                            ...
								                            <div class="container">
																...
																<table class="table table-striped">
																	...
																	<tr><td colspan="3" style="width:100%; text-align:left; vertical-align: baseline; padding:20px;">
																		<c:forEach var="getFileList" items="${getFileList }">
																		<iframe width="800px" height="500px" src="file/${getFileList.SFILE_NAME}"></iframe>
																		</c:forEach>
																...
																<div class="row" >
														    		<div class="col-sm-2">
																		<button class="btn btn-block" onclick="window.location='/video'">목록으로</button>
																		<c:choose>
